        ...
        public System.Data.DataTable replacedt(System.Data.DataTable dt)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (sales!="") {
                    ...
                    dt.Rows[i]["代理价"] = Convert.ToInt32(dt.Rows[i].ItemArray[4].ToString() == "" ? "0" : dt.Rows[i].ItemArray[4].ToString()) * Convert.ToInt32(dt.Rows[i].ItemArray[2].ToString() == "" ? "0" : dt.Rows[i].ItemArray[2].ToString());
                    if (dr.Length > 0)
                    {
